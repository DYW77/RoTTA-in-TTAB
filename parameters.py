...
def get_args():
    ...
    parser.add_argument(
        "--ckpt_path",
        default="E:/GITHUB/models/models/resnet26/cifar10/resnet26_with_head-150-regular-0.9343000054359436.pth",
        type=str,
    )
    #E:/GITHUB/models/models/resnet26/cifar10/resnet26_with_head-150-regular-0.9343000054359436.pth
    #E:/GITHUB/models/models/wideresnet28_10/cifar10/wideresnet28_10_with_head-150-regular-0.9458999633789062.pth
    #E:/GITHUB/models/models/Standard/Standard.pt
    parser.add_argument("--seed", default=2022, type=int)
    parser.add_argument("--device", default="cpu", type=str)#cuda:0
    ...
    parser.add_argument(
        "--data_names", default="cifar10_c_deterministic-brightness-5", type=str
